...
<head>
    ...
    <style>
        ...
        canvas{
            width: 100%;
            /*min-width: 100%; CONFIGURAÇÕES USADAS NA TESTAGEM DA FUNÇÃO DE ZOOM
            zoom: 1.3;*/
        }
        .editor{
            width: 100%;
...
<body>
    ...
    <div class="conteudo">
        ...
        <div class="esquerda">
            ...
            <button type="button" onclick="renderPage()">Carregar Página</button> 
            <!--<label for="">Zoom:</label> FUNÇÃO DE ZOOM, DEIXAR PARA MAIS A FRENTE
            <button type="button" onclick="ajustarZoom(1, 'pdf-canvas')">+</button>
            <button type="button" onclick="ajustarZoom(2, 'pdf-canvas')">-</button>
            <br>-->
        ...
        <div class="direita">
            ...
            <button type="button" onclick="ajustarZoom(1, 'conteudo')">+</button>
            <button type="button" onclick="ajustarZoom(2, 'conteudo')">-</button>
    ...
    <script type="text/javascript" src="script/etapa2-2.js"></script>
